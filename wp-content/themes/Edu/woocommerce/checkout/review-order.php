...
<div id="order_review">
    ...
    <div id="payment">
                    ...
                    foreach ( $available_gateways as $gateway ) {
                        ...
                        <li class="payment_method_<?php echo $gateway->id; ?>">
                            ...
                            if ( $gateway->has_fields() || $gateway->get_description() ) :
                                echo '<div class="alert alert-info st-noti st-noti-info  payment_box payment_method_' . $gateway->id . '" ' . ( $gateway->chosen ? '' : 'style="display:none;"' ) . '>';
        ...
        <div class="form-row place-order">
            ...
            echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button alt btn btn-default" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
            ?>
